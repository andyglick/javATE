...
public class CriteriaDateSpecificationTest extends TestCase {
	...
	public void testLowerBound() {
		...
		CriteriaDateSpecification<FakeDateEntity> spec = new CriteriaDateSpecification<FakeDateEntity>("date");
